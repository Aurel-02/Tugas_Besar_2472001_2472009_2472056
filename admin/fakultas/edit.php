    ...
    <form method="POST" action="update.php">
        <div class="modal-body">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" value="<?= $data['id_fakultas'] ?>" readonly>
            </div>

            <div class="mb-3">
                <label class="form-label">Nama Fakultas</label>
                <input type="text" name="nama_fakultas" class="form-control" value="<?= $data['nama_fakultas'] ?>" required>
            </div>
